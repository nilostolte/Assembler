...
Because of this fact, and since the 8051 allows copying any bit in the registers to the flags, all is needed is to copy bit 4 of the accumulator to the carry flag, and then adding `0x30` with the carry 
